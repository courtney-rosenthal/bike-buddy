...
* Ability for a registered user to initiate a buddy request to another user

Deficiencies:
* Need to provide some reasonable defaults for new user profiles.
* On new profiles, the location picker is defaulting to France.
* On profile updates, the location picker is zoomed too far out.
